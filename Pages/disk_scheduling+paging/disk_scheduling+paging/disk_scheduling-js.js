			...
			pre=1;
                ...
                function lifo(inp, ini, final) {
                        ...
                        if (pre) {
                          ...
                          document.getElementById("seek_sequence").innerHTML = "Seek Sequence: " + seekSequence.join(' -> ');
                        }
                      }
